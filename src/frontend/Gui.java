...
public class Gui extends Application {
	...
	/**
	 * M�todo que imprime a tela de contatos do chat;
	 */
	...
	/**
	 * M�todo para imprimir a tela de chat entre o usu�rio e o contato escolhido;
	 */
	...
	/**
	 * M�todo para mostrar mesagens antigas entre o usu�rio e seu contato escolhido;
	 */
	...
	/**
	 * M�todo para mostrar uma nova mensagem no chat;
	...
	/**
	 * M�todo para conferir se um cpf � v�lido ou n�o;
	 * @param cpf - string com o cpf
	 * @return - boolen com a verifica��o;
	 */
